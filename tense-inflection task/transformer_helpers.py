...
def create_lm(in_vocab_size, vec_dim, n_heads, encoder_n_layers, decoder_n_layers=0) -> torch.nn.Module:
    args = dict(embedding_init="xavier", scale_mode="opennmt")

    return TransformerLM(
        in_vocab_size, vec_dim, nhead=n_heads, num_encoder_layers=encoder_n_layers,
